...
public class CustomHeaderPopulateFilter implements GatewayFilter{
	...
	public CustomHeaderPopulateFilter(JwtUtility jwtUtility, UserEntityRepository userEntityRepository) {
